				...
				<div className="budget-container">
					...
					<div className="content-container">
						<div className="purchases-container">
							<AddPurchase purchases={purchases} addPurchase={this.props.addPurchase} />
...
export default connect(mapStateToProp, { requestBudgetData, requestUserData, addPurchase, removePurchase })(Budget);
